...
class Talaba(models.Model):
    ...
    kurs=models.CharField(max_length=20,choices=[("1-kurs","1-kurs"),("2-kurs","2-kurs"),("3-kurs","3-kurs"),("4-kurs","4-kurs")])
...
class Muallif(models.Model):
    ...
    def __str__(self):
        return f"Muallif {self.ism} kiroblar soni-{self.kitoblar_soni} ta"
